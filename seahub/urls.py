...
from seahub.api2.endpoints.file_history import FileHistory
...
urlpatterns = patterns(
    ...
    url(r'^api/v2.1/repos/(?P<repo_id>[-0-9a-f]{36})/file-history/$', FileHistory.as_view(), name='api-v2.1-file-history'),
